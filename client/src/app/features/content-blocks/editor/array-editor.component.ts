            ...
            <div class="card-body p-4">
              <div class="flex items-center justify-between mb-3">
                 <div class="flex items-center gap-2 cursor-move text-slate-400 hover:text-slate-600" cdkDragHandle>
                    ...
                    <span class="text-xs font-bold uppercase tracking-wider text-slate-500">{{ 'BLOCK_PROP_ITEM_LABEL' | translate }} {{ i + 1 }}</span>
                 </div>
              ...
              <ng-template #primitiveInput>
                 <input [formControl]="asFormControl(control)" class="input input-sm input-bordered w-full" [placeholder]="'Value...' | translate" />
              </ng-template>
